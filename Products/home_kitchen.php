...
?>
    ...
    <div class="content">
            <a href='./product_details.php?id=<?php echo $row['id'];?>&name=<?php echo 'home_kitchen_products'?>'>  
            <img src="img3/<?php echo $row['image']; ?>" alt="Image">
            <h5 style=' color:purple;margin-top:25px; height:200px;'><?php echo $row['name']; ?></h5>
